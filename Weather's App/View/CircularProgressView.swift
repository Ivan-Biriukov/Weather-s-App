...
class CircularProgressView: UIView {
    ...
    fileprivate func createProgressView(){
        ...
        let circularPath = UIBezierPath(arcCenter: center, radius: frame.width / 2, startAngle: CGFloat(0.9 * .pi), endAngle: CGFloat(2.11 * .pi), clockwise: true)
